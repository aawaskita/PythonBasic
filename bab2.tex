...
\begin{figure}[h!]
\begin{center}
\subfigure[]{\label{fig:extend1}}\includegraphics[scale=1.25]{pics/extend1.png}
\subfigure[]{\label{fig:extend2}}\includegraphics[scale=1.25]{pics/extend2.png}
...
\lstinputlisting[language=python, numbers=left, numberstyle=\small, caption=Mendefinisikan fungsi sederhana, showstringspaces=false, label=lst:anggota]{script/anggota.py}
